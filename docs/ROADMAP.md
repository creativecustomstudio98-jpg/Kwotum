...
| Silnik pricing/scoring    | self-service UI i pełna ścieżka gotowe    | kalibracja na regułach firmy pilotażowej        |
...
| Webhook                   | aplikacyjny v1 i ADR-034 gotowe lokalnie  | scheduler, alerty i UAT na stagingu             |
...
| 12ZD | ukończony       | czysty, audytowalny baseline repozytorium          | immutable SHA i zielone CI/Semgrep/Gitleaks                 |
| 12ZE | ukończony       | self-service pricing, scoring i wynik w builderze  | konfiguracja → publikacja → widget → lead                   |
| 12ZF | lokalnie gotowy | webhook v1 utrzymany przez ADR-034                 | scheduler, alerty i UAT w 13A                               |
