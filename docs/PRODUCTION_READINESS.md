...
| ----- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| PR-01 | P0 / częściowo       | FTZ-03A i FTZ-03B są gotowe do release'u: exact allowlista, rozproszony limiter i obowiązkowe Siteverify z host/action/replay/fail-closed. Managed widget i klucze Vercel Production only są skonfigurowane; brak wdrożenia i produkcyjnego smoke.                                                                | ADR-040/041, migracja `20260810000200`, testy request guard, Turnstile unit/route i Playwright retry                 | Wdrożyć migracje i aplikację; sprawdzić CSP, obcy origin, 429, replay i submit na rzeczywistym embedzie Fortez.                         |
...
| PR-07 | P1 / częściowo       | Resend, aplikacyjny outbox, pięciominutowy scheduler, rozdzielone sekrety, heartbeat i dokładnie jedna syntetyczna dostawa firmy działają produkcyjnie. Biały renderer v2 i czytelne etykiety są wdrożone bez ponownej wysyłki UAT. DPA, niezależny alert probe i test v2 w realnych klientach pozostają otwarte. | PR #27, SHA `c74f38e28d20775c7dfa5b6730eb0d5336d48aef`, migracja `20260811000300`, `docs/NOTIFICATION_OPERATIONS.md` | Zatwierdzić DPA, podłączyć niezależny alert 503 → recovery oraz wykonać test białego HTML/text v2 w Gmailu, Apple Mail i Outlooku.      |
