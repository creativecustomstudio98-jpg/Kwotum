...
| Centrum integracji Kwotum       | `ui/integrations-kwotum-final/README.md`                | `ui/integrations-kwotum-final/VISUAL_QA_REPORT.md`, `WEBHOOKS.md`, `WORDPRESS_PLUGIN.md`                 |
