...
Przed włączeniem ruchu osób rzeczywistych należy zachować datę i wersję obu
dokumentów, ocenić transfer oraz listę podprocesorów; sama konfiguracja kluczy
i testowe wdrożenie kodu nie stanowią akceptacji prawnej.
