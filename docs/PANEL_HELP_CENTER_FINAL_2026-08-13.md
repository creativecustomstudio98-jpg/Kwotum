...
Desktop korzysta z jednej białej powierzchni, lewego spisu treści i prawej
kolumny instrukcji. Mobile zachowuje tę samą kolejność DOM, zwija układ do
jednej kolumny i udostępnia spis treści jako przewijalny zestaw skrótów.
